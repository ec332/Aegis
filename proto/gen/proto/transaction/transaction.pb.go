...
func (TransactionType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_transaction_transaction_proto_enumTypes[0].Descriptor()
}

func (TransactionType) Type() protoreflect.EnumType {
	return &file_proto_transaction_transaction_proto_enumTypes[0]
}
...
const file_proto_transaction_transaction_proto_rawDesc = "" +
	"\n" +
	"#proto/transaction/transaction.proto\x12\vtransaction\x1a\x1fgoogle/protobuf/timestamp.proto\"\x82\x02\n" +
...
var file_proto_transaction_transaction_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
func file_proto_transaction_transaction_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_transaction_transaction_proto_enumTypes,
